...
def calculate_score(score):
    current_time = score
    loaded_time = load_score("ext/score.txt")
...
class CardLayer(cocos.layer.Layer):
    ...
    def __init__(self, image_path):
        ...
        self.back = cocos.sprite.Sprite('ext/pictures/back.png', anchor=(0, 0))
...
class Button(cocos.layer.Layer):
    ...
    def __init__(self, pos):
        super().__init__()
        self.spr = cocos.sprite.Sprite('ext/pictures/back_to_main.png')
...
class BestTimeScene(cocos.scene.Scene):
    ...
    def on_enter(self):
        super().on_enter()
        self.label.element.text = load_score("ext/score.txt")
...
class WinningScene(cocos.scene.Scene):
    ...
    def on_enter(self):
        ...
        if calculate_score(Timer.current_time):
            save_score("ext/score.txt", Timer.current_time)
